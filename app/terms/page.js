        ...
        <LegalCard>
          {lang === 'pl' ? (
            <div>
              ...
              <ol>
                <li><strong>Darmowy dostęp:</strong> Pełny, bezpłatny dostęp do platformy przez pierwsze 6 miesięcy od dnia jej oficjalnej komercyjnej premiery rynkowej.</li>
            ...
            <div>
              ...
              <ol>
                <li><strong>Free Access:</strong> Full, unrestricted access to the software for 6 months starting from the official commercial launch date.</li>
